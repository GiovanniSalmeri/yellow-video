    ...
    public function onParseContentShortcut($page, $name, $text, $type) {
        ...
        if ($name=="video" && ($type=="block" || $type=="inline")) {
            ...
            $services = [
                ...
                "peertube" => [ "/^([A-Za-z0-9]{22})@([A-Za-z0-9\-_]+(?:\.[A-Za-z0-9\-_]+)*)$/", "https://@2/videos/embed/@1?warningTitle=0", "iframe" ],
                "peertube2" => [ "/^([a-z0-9]{8}-[a-z0-9]{4}-[a-z0-9]{4}-[a-z0-9]{4}-[a-z0-9]{12})@([A-Za-z0-9\-_]+(?:\.[A-Za-z0-9\-_]+)*)$/", "https://@2/videos/embed/@1?warningTitle=0", "iframe" ],
                ...
                "bilibili" => [ "/^BV[A-Za-z0-9]{10}$/", "https://player.bilibili.com/player.html?bvid=@0&danmaku=0&high_quality=1", "iframe" ],
                "bilibili2" => [ "/^av([1-9][0-9]{0,8})$/", "https://player.bilibili.com/player.html?aid=@1&danmaku=0&high_quality=1", "iframe" ],
